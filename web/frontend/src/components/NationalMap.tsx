...
const simulatedStations = [
  ...
  { id: "sim-5", name: "Bilbao", location: "Bilbao", lat: 43.263, lng: -2.935, waterLevelCm: 145, rainMm: 20, turbidity: 2.9, humidity: 72 },
  { id: "sim-6", name: "Zaragoza", location: "Zaragoza", lat: 41.6488, lng: -0.8891, waterLevelCm: 76, rainMm: 8, turbidity: 1.2, humidity: 41 },
  { id: "sim-7", name: "Málaga", location: "Málaga", lat: 36.7213, lng: -4.4214, waterLevelCm: 88, rainMm: 10, turbidity: 2.5, humidity: 58 },
  { id: "sim-8", name: "Valladolid", location: "Valladolid", lat: 41.6523, lng: -4.7245, waterLevelCm: 92, rainMm: 13, turbidity: 1.5, humidity: 48 },
  { id: "sim-9", name: "Vigo", location: "Vigo", lat: 42.2406, lng: -8.7207, waterLevelCm: 130, rainMm: 26, turbidity: 3.1, humidity: 80 },
  { id: "sim-10", name: "A Coruña", location: "A Coruña", lat: 43.3623, lng: -8.4115, waterLevelCm: 98, rainMm: 15, turbidity: 2.8, humidity: 76 },
];
